...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Hub Education — Learn without limits" },
      { name: "description", content: "Discover expert-led online courses in web development, design, data, business and more." },
      { property: "og:title", content: "Hub Education — Learn without limits" },
